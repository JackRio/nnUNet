...
class ExperimentPlanner3D_v21_Subso_1x1x1(ExperimentPlanner3D_v21):
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        ...
        self.data_identifier = "nnUNetData_plans_v2.1_subso_1x1x1"
        self.plans_fname = join(self.preprocessed_output_folder,
                                "nnUNetPlansv2.1_subso_1x1x1_plans_3D.pkl")
